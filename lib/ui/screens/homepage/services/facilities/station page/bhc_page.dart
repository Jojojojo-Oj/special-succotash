...
import 'package:agapay_users/ui/screens/homepage/services/facilities/station%20maps/bhc_map.dart';
import 'package:agapay_users/ui/screens/homepage/services/facilities/station%20page/station_card.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class BhcPage extends StatelessWidget {
  const BhcPage({super.key});
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: FacilitiesCard(
                ...
                onTap: (){      
                  Navigator.push(
                    context, 
                    MaterialPageRoute(builder: (context) => BhcMap()));
                },
                )
              ),
            ...
            Padding(
              ...
              child: Text("Barangay Health Center", style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.w600), textAlign: TextAlign.left,),
              ),
            ...
            Padding(
              padding: EdgeInsets.only(top: 10, bottom: 10,),
              child: StationCard(
                imagePath: "assets/images/bhc_icon.svg", 
                title: "Grace Park Health Center", 
                descript: "3rd Street, 9th Ave, Grace Park East, Caloocan City",               
                )
              ),
            ...
            Padding(
              ...
              child: StationCard(
                imagePath: "assets/images/bhc_icon.svg", 
                title: "Calaanan ABTC Health Center", 
                descript: "113 L. Nadurata Street, 7th Ave, Grace Park West, Caloocan City",               
                )
              ),
            ...
            Padding(
              ...
              child: StationCard(
                imagePath: "assets/images/bhc_icon.svg", 
                title: "Sampalukan Health Center", 
                descript: "Perpetua Street, Sampalukan, Caloocan City",               
                )
              ),
            ...
            Padding(
              ...
              child: StationCard(
                imagePath: "assets/images/bhc_icon.svg", 
                title: "Barrio San Jose Health Center", 
                descript: "580 Tagaytay St, Grace Park East, Caloocan City",               
                )
              ),
            ...
            Padding(
              ...
              child: StationCard(
                imagePath: "assets/images/bhc_icon.svg", 
                title: "Barangay 120 Health Center", 
                descript: "Grace Park, 2nd Street, 192 2nd Ave, Grace Park East, Caloocan City",               
                )
              ),
            ...
            Padding(
              ...
              child: StationCard(
                imagePath: "assets/images/bhc_icon.svg", 
                title: "E. Rodriguez Health Center", 
                descript: "Violeta, Grace Park East, Caloocan, Metro Manila",               
                )
              ),
